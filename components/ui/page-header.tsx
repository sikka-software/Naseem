...
function PageHeaderHeading({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h1 className={cn("font-redaction text-3xl leading-tight md:text-5xl", className)} {...props} />
  );
}
...
function PageHeaderDescription({
  ...
  return (
    <p
      className={cn("max-w-2xl text-balance text-sm font-light md:text-base", className)}
      {...props}
    />
  );
}
