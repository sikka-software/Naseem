...
<Tabs items={["pnpm", "npm", "bun"]}>
    ```bash tab="pnpm"
    pnpm dlx shadcn@latest add https://ui.sikka.io/r/product-card-01-block.json
    ```
    ```bash tab="npm"
    npx shadcn@latest add https://ui.sikka.io/r/product-card-01-block.json
    ```
    ```bash tab="bun"
    bun x --bun shadcn@latest add https://ui.sikka.io/r/product-card-01-block.json
    ```
</Tabs>
...
<Tabs items={["pnpm", "npm", "bun"]}>
    ```bash tab="pnpm"
    pnpm dlx shadcn@latest add https://ui.sikka.io/r/product-card-01-block.json -c ./apps/www
    ```
    ```bash tab="npm"
    npx shadcn@latest add https://ui.sikka.io/r/product-card-01-block.json -c ./apps/www
    ```
    ```bash tab="bun"
    bun x --bun shadcn@latest add https://ui.sikka.io/r/product-card-01-block.json -c ./apps/www
    ```
</Tabs>
