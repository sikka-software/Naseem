...
For more info see the [LICENSE](https://github.com/sikka-software/naseem/blob/main/LICENSE) file.
...
<Accordions>
  <Accordion title="Can I use this in my project?">
    Definitely! **naseem** is free for personal and commercial projects. 
    For more info see the [LICENSE](https://github.com/sikka-software/naseem/blob/main/LICENSE) file.
  </Accordion>
