...
<Steps>
  ...
  <Step>
   ### Add your first component
    ...
    ```bash tab="pnpm"
    pnpm shadcn@latest add https://ui.sikka.io/r/star-rating-basic-ex-01.json
    ```
    ```bash tab="npm"
    npx shadcn@latest add https://ui.sikka.io/r/star-rating-basic-ex-01.json
    ```
    ```bash tab="bun"
    bun shadcn@latest add https://ui.sikka.io/r/star-rating-basic-ex-01.json
    ```
    </Tabs>
